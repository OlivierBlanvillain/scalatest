...
trait Requirements {
   ...
   */
  def require(condition: Boolean)(implicit prettifier: Prettifier): Unit = macro RequirementsMacro.require // MM
   ...
   */
  def require(condition: Boolean, clue: Any)(implicit prettifier: Prettifier): Unit = macro RequirementsMacro.requireWithClue // MM
   ...
   */
  def requireState(condition: Boolean)(implicit prettifier: Prettifier): Unit = macro RequirementsMacro.requireState // MM
   ...
   * @throws NullPointerException if <code>message</code> is <code>null</code>.
   */
  def requireState(condition: Boolean, clue: Any)(implicit prettifier: Prettifier): Unit = macro RequirementsMacro.requireStateWithClue // MM
   ...
   */
  def requireNonNull(arguments: Any*)(implicit prettifier: Prettifier, pos: source.Position): Unit = macro RequirementsMacro.requireNonNull // MM
}
