...
// TODO: mention not short circuited, and the precendence is even between and and or
  ...
  final class AndNotWord {
     ...
     * </pre>
     **/
    def be(aType: ResultOfATypeInvocation[_]): Matcher[T] = macro TypeMatcherMacro.andNotATypeMatcher // MM
     ...
     * </pre>
     **/
    def be(anType: ResultOfAnTypeInvocation[_]): Matcher[T] = macro TypeMatcherMacro.andNotAnTypeMatcher // MM
...
// TODO: Write tests and impl for contain ResultOfKey/ValueWordApplication
  ...
  final class OrNotWord {
     ...
     * </pre>
     **/
    def be(aType: ResultOfATypeInvocation[_]): Matcher[T] = macro TypeMatcherMacro.orNotATypeMatcher // MM
     ...
     * </pre>
     **/
    def be(anType: ResultOfAnTypeInvocation[_]): Matcher[T] = macro TypeMatcherMacro.orNotAnTypeMatcher // MM
