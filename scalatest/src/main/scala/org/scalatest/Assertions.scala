...
trait Assertions extends TripleEquals  {
   ...
   */
  @deprecated("use scala.Predef.assert instead")
  ...
  def assert(condition: Boolean, clue: Any)(implicit prettifier: Prettifier, pos: source.Position): Assertion = {
    // macro AssertionsMacro.assertWithClue
    scala.Predef.assert(condition, clue)
    new Assertion {}
  }
  ...
  def assume(condition: Boolean, clue: Any)(implicit prettifier: Prettifier, pos: source.Position): Assertion = {
      // macro AssertionsMacro.assumeWithClue
      scala.Predef.assert(condition, clue)
      new Assertion {}
    }
   ...
   */
  @deprecated
  def assertTypeError(code: String)(implicit pos: source.Position): Assertion =
    new Assertion {}
    // macro CompileMacro.assertTypeErrorImpl
   ...
   */
  def assertCompiles(code: String)(implicit pos: source.Position): Assertion =
    new Assertion {}
    // macro CompileMacro.assertCompilesImpl
