...
final class NotWord {
   ...
   * </pre>
   **/
  def matchPattern(right: PartialFunction[Any, _]): Matcher[Any] = macro MatchPatternMacro.notMatchPatternMatcher // MM
   ...
   * </pre>
   **/
  def be(aType: ResultOfATypeInvocation[_]) = macro TypeMatcherMacro.notATypeMatcher // MM
   ...
   * </pre>
   **/
  def be(anType: ResultOfAnTypeInvocation[_]) = macro TypeMatcherMacro.notAnTypeMatcher // MM
